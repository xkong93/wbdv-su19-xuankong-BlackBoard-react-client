...
const NavBarAndTableHead = ({course,changeView, addCourse,titleChange}) => (
    <div>
            ...
            <div className="navbar-nav mr-auto ml-2">
                <form className="form-inline mb-0 ">
                    ...
                    <div className="input-group">
                        ...
                        />
                        <button onClick={()=>addCourse(course)} className="btn btn-outline-light" type="submit">
                            <i className="fa fa-plus"/>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="d-xs-block col-xs-2 col-sm-2 text-right">
                        <button onClick={() => changeView()} id="changeToCardsView"><i className="fa fa-th"></i>
                        </button>
